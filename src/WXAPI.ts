export default class WXAPI {
    ...
    public static wxLogin_CloudFlame(onSuccess: Function, onFail: Function) {
    ...
    protected static onRewardedVideoAdLoad_CloudFlame() {
        console.log('激励视频 广告加载完成')
    }
    protected static onRewardedVideoAdError_CloudFlame(err) {
        console.log('激励视频 广告加载失败' + err)
        if (WXAPI._onRewardedVideoAdFailed) {
            WXAPI._onRewardedVideoAdFailed();
        }
    }
    protected static onRewardedVideoAdClose_CloudFlame(res) {
    ...
    protected static RegRewardedVideoAdEvent_CloudFlame(rewardedVideoAd) {
    ...
    public static ShowRewardedVideoAd_CloudFlame(onAdClose: Function, onFailed: Function) {
        if (Laya.Browser.onMiniGame) {
    ...
    //-------------------------小游戏跳转---------------------------
    public static NavigateToMiniProgram_CloudFlame(appId: string, path: string, onSuccess: Function, onFail: Function, onComplate: Function) {
        if (Laya.Browser.onMiniGame) {
    ...
    public static Share_CloudFlame(complate: Function, titel: string, imageUrl: string) {
        if (Laya.Browser.onMiniGame) {
            WXAPI._onShow = () => {
    ...
    //--------------------插屏幕广告---------------------------------------
    public static ShowInterstitialAd_CloudFlame(onAdClose: Function, onFailed: Function)  {
        if (Laya.Browser.onMiniGame) {
     ...
     * @memberof WXAPI
     */
    public static GetLaunchOptionsSync_CloudFlame() {
     ...
     * @memberof WXAPI
     */
    public static SetShareMenu_CloudFlame(titel: string, imageUrl: string, success?: Function, fail?: Function, complate?: Function) {
        if (Laya.Browser.onMiniGame) {
    ...
    //检测更新
    public static CheckUpdate_CloudFlame()
    {
        if (Laya.Browser.onMiniGame) 
        {
